...
深入解析 .NET 9 基础库的新特性。这包括 Base64Url 类的引入、集合类型优化、BinaryFormatter 的移除以及加密功能的拓展。通过实例和详细分析，我们帮助开发者快速适应和应用这些更新，从而提升应用性能和安全性。
...
- [.NET 9 更新示例代码](https://github.com/sdcb/blog-data/tree/master/2024/dotnet9-libs)
